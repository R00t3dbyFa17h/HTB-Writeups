...
**Target:** *Blue (Hack The Box)* **OS:** *Windows* **Difficulty:** *Easy* **Attack Vectors:** *SMB Vulnerability (MS17–010) -\> Remote Code Execution -\> System Privilege.*
...
> <a href="https://medium.com/technology-hits/%EF%B8%8F-the-breach-in-the-wall-exploiting-ms17-010-on-htb-blue-259c9cb66da0?sk=3512bd0c7fe83f90663871b70d1fb299" class="markup--anchor markup--pullquote-anchor" data-href="https://medium.com/technology-hits/%EF%B8%8F-the-breach-in-the-wall-exploiting-ms17-010-on-htb-blue-259c9cb66da0?sk=3512bd0c7fe83f90663871b70d1fb299" target="_blank">**Not a Member Click Here to Read Full-Story!!**</a>
...
- <span id="3ecb">**Port 445 (SMB):** Windows 7 Professional SP1.</span>
- <span id="64fa">**Vulnerability:** CVE-2017–0143 (MS17–010 / EternalBlue).</span>
- <span id="2f9b">**Risk:** Critical (Remote Code Execution as System).</span>
...
1.  <span id="90c4">**Immediate Patching:** Apply Microsoft Security Bulletin MS17–010 immediately to all Windows systems.</span>
2.  <span id="9e8e">**Disable SMBv1:** Disable the legacy SMBv1 protocol via Group Policy, as it is obsolete and insecure.</span>
3.  <span id="43d8">**Network Segmentation:** Isolate legacy systems that cannot be patched into restricted VLANs with strict firewall rules blocking Port 445 from the general network.</span>
...
By <a href="https://medium.com/@nicholasmullenski" class="p-author h-card">Nicholas Mullenski</a> on [January 2, 2026](https://medium.com/p/259c9cb66da0).

<a href="https://medium.com/@nicholasmullenski/%EF%B8%8F-the-breach-in-the-wall-exploiting-ms17-010-on-htb-blue-259c9cb66da0" class="p-canonical">Canonical link</a>
